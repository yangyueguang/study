...
' Gets all list items as an array, or an empty array if the list does not contain any items.
Public Property Get Items() As Variant()
    If mCount = 0 Then
        ' Return an empty array.  This is the only way I know of to create an empty array in VBA.  It's kind of wonky because the resulting array has LBound = 0 and UBound = -1.
        Items = Array()
    Else
        Dim arr() As Variant
...
' Adds a value to the end of the list, if the list does not already contain that value.
...
' Adds a range of items to the end of the list, only adding the items that are not already contained in the list.
