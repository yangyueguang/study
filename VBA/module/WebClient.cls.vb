...
Public Authenticator As WebHool
...
web_ErrorHandling:
    ...
    ' Check lower 16 bits from error (e.g. 80072EE2 -> 2EE2 -> 12002)
...
Public Function PrepareCurlRequest(Request As WebRequest) As String
    ...
    ' Setup authenticator
    web_BeforeExecute Request
    ' Set timeouts (max time = resolve + sent + receive)
...
Private Sub web_BeforeExecute(web_Request As WebRequest)
    ...
    End If
    ' Preparing request includes adding headers -> Needs to happen after BeforeExecute in case headers were changed
    web_Request.Prepare
End Sub
