      ...
      <div class="row justify-content-between">
        ...
        <div class="col-4 col-xl-4 col-lg-4 col-md-4 col-sm-4 text-right">
          <div class="social-info">
            ...
            <img class="twitter" src="@/assets/image/twitter.png">
            <img class="pinterest" src="@/assets/image/pinterest.png">
            <img class="facebook" src="@/assets/image/facebook.png">
            <img class="instagram" src="@/assets/image/insta.png">
          </div>
        </div>
      </div>
    </div>
