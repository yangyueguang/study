    ...
    <div id="heroControls" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="img-fluid" src="@/assets/image/jum1.jpg" alt="First slide">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="@/assets/image/jum2.jpg" alt="Second slide">
        </div>
        <div class="carousel-item">
          <img class="img-fluid" src="@/assets/image/jum3.jpg" alt="Third slide">
        </div>
      </div>
    </div>
  </section>
