  ...
  <div class="container-flex">
    <nav class="navbar navbar-light">
      ...
      <a class="navbar-brand py-0 pl-5">
          <img src="@/assets/image/fi-logo.svg" width="50" height="50">
      </a>
      <!--Header navigation-->
      ...
      <p class="navbar-item ml-auto">
        ...
        <div class="bag" @click="openCart">
            <img class="pb-1" src="@/assets/image/cart.svg">
...
.search {
  outline: none;
  border: 1px #F8F8F8;
  background: #ededed url('../assets/image/search.png') no-repeat 5px center;
