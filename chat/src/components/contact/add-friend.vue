<template>
  <div class="add-friend">
    <header id="wx-header">
      <div class="center">
        <div v-on:click="$router.back()" class="iconfont icon-return-arrow"><span>返回</span></div>
        <span>添加朋友</span>
      </div>
    </header>
    <div class="search-line">
      <span class="iconfont icon-search"></span><input type="text" placeholder="微信号/手机号">
    </div>
    <p style="padding-top:8px;text-align: center;">
      <span>我的微信号:</span><span>10086</span>
    ...
    <div class="weui-cells">
      ...
      <a class="weui-cell weui-cell_access">
        ...
        <div class="weui-cell__bd"><p>公众号</p><p>获得更多资讯和服务</p></div>
        <div class="weui-cell__ft"></div>
      </a>
    </div>
  </div>
