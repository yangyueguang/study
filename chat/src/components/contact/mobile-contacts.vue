    ...
    <section>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">白浅</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">关羽</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">黄月英</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">刘备</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">孙尚香</div>
        </div>
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">孙权</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">夜华</div>
        </div>
      </div>
      ...
      <div class="weui-cells">
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">阿荡</div>
        </div>
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">诸葛亮</div>
        </div>
        <div class="weui-cell weui-cell_access">
          ...
          <div class="weui-cell__bd">甄姬</div>
        </div>
      </div>
    </section>
  </div>
