<template>
  <div class="dialogue-info">
    <header id="wx-header">
      <div class="center">
        <div class="iconfont icon-return-arrow" v-on:click="$router.back()"><span>返回</span></div>
    ...
    <div class="member">
      <ul class="chat-dialogue-entry-collect">
        <li v-for="(item,index) in $route.query.msgInfo.user" :key="index">
          <div><img :src="item.headerUrl"></div><p>{{item.remark||item.nickname}}</p>
        </li>
        <li><div><span class="iconfont icon-chat-detail-add"></span></div></li>
      </ul>
    </div>
    <div class="weui-cells">
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">群聊名称</div><div class="weui-cell__ft">{{$route.query.msgInfo.group_name}}</div>
      </div>
      <div class="weui-cell weui-cell_access">
    ...
    <div class="weui-cells">
      <div class="weui-cell weui-cell_switch">
        ...
        <div class="weui-cell__ft">
          <input type="checkbox" class="weui-switch" v-model="$route.query.msgInfo.quiet"></div>
      </div>
      <div class="weui-cell weui-cell_switch">
    ...
    <div class="weui-cells">
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">聊天文件</div><div class="weui-cell__ft"></div>
      </div>
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">查找聊天内容</div><div class="weui-cell__ft"></div>
      </div>
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">设置当前聊天背景</div><div class="weui-cell__ft"></div>
      </div>
      <div class="weui-cell weui-cell_access">
        <div class="weui-cell__bd">投诉</div><div class="weui-cell__ft"></div>
      </div>
    </div>
    <div class="weui-cells">
      <div class="weui-cell">
        <div class="weui-cell__bd">清空聊天记录</div><div class="weui-cell__ft"></div>
      </div>
    </div>
